...
const ROLE_NOTIFICATION_TYPES: Record<string, string[]> = {
    MANAGER: ['STOCK_ALERT', 'ORDER_NEW', 'ORDER_UPDATE', 'PAYMENT_UPDATE', 'INFO', 'WARNING', 'SUCCESS', 'ERROR', 'LOW_STOCK', 'REORDER_NEEDED', 'STOCK_UPDATE'],
    EMPLOYEE: ['STOCK_ALERT', 'ORDER_NEW', 'ORDER_UPDATE', 'INFO', 'WARNING', 'LOW_STOCK', 'STOCK_UPDATE'],
    CONTRACTOR: ['ORDER_NEW', 'ORDER_UPDATE', 'PAYMENT_UPDATE', 'INFO', 'SUCCESS', 'CREDIT_WARNING', 'PROJECT_MATCH', 'QUOTE_NEW', 'QUOTE_UPDATE'],
