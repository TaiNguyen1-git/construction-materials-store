...
export default function ProcurementManagementPage() {
    ...
    // Removed global 'loading' state to prevent UI blocking
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    >
                        <RefreshCw className={`w-3.5 h-3.5 ${loadingSuggestions || loadingRequests ? 'animate-spin' : ''}`} />
                    </button>
                </div>
            </div>
                ...
                {[
                    ...
                    <div key={i} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="text-2xl font-black text-slate-900">
                            {(loadingSuggestions || loadingRequests) ? (
            ...
            {activeTab === 'requests' && (
                loadingRequests ? (
                    <div className="py-24 text-center">
                        <div className="w-12 h-12 border-4 border-blue-600/20 border-t-blue-600 rounded-full animate-spin mx-auto mb-4"></div>
                        <span className="text-xs font-black text-slate-400 uppercase tracking-widest">Đang tải lịch sử nhập hàng...</span>
                    </div>
                ) : (
