  ...
  function ProductGridSkeleton({ viewMode }: { viewMode: 'grid' | 'list' }) {
    return (
      <div className="space-y-8 animate-pulse">
        {/* Controls Skeleton */}
        <div className="h-24 bg-white rounded-[2rem] border border-neutral-100 p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
        ...
        <div className={`grid gap-6 ${viewMode === 'grid'
            ...
            {Array.from({ length: 8 }).map((_, i) => (
              viewMode === 'grid' ? (
                <div key={i} className="bg-white rounded-2xl border border-neutral-100 p-5 flex flex-col h-[380px] justify-between">
                ...
                <div key={i} className="bg-white rounded-2xl border border-neutral-100 p-6 flex flex-col sm:flex-row gap-6 h-auto sm:h-44 items-stretch justify-between">
                  <div className="w-full sm:w-48 h-44 sm:h-full bg-slate-100 rounded-xl flex-shrink-0" />
