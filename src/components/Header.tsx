...
import { Package, Heart, User, LogOut, ChevronDown, Home, Tag, Info, Phone, LogIn, UserPlus, Calculator, HardHat, FolderKanban, Sparkles, Building2, Headset, BookOpen, TrendingUp } from 'lucide-react'
